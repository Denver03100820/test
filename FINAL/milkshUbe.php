        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card" style="margin-top: 100px;">
                    <div class="card-body">
                        <div class="textcolor">
                            <h4>Ube Milkshake</h4><hr style="border-top: 1px solid;">
                            <p>Be refreshed with this milky ube shake for it will give you a moment that will last forever.</p><br>
                            
                            <h3>Ingredients: </h3><br>
                            <h5>Whole Milk, Ube, Granulated sugar, Vanilla extract, Vanilla Ice Cream</h5><br><br>
