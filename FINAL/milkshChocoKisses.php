        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card" style="margin-top: 100px;">
                    <div class="card-body">
                        <div class="textcolor">
                            <h4>Choco Kisses Milkshake</h4><hr style="border-top: 1px solid;">
                            <p>Feel the love with this shake, it contains of milk joy powder that will surely win your heart.</p><br>
                            
                            <h3>Ingredients: </h3><br>
                            <h5>Chocolate Ice Cream, Chocolate candy bars, Whipped Cream, Chocolate Shavings, Chocolate Syrup, Crushed Cookies</h5><br><br>
