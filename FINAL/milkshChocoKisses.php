...
<body class="fixed-bg">
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="img/ChocoKisses(bg).png" class="centerimage">
            </div>
            ...
            <div class="col-md-6">
                    ...
                    <div class="semi-card">
                        <div class="textcolor">
                            <h2 style="margin-left: 7px; margin-top:5px">Choco Kisses Milkshake</h2><hr style="border-top: 1px solid;">
                            <p style="font-size:15px; margin-left: 10px">Feel the love with this shake, it contains of milk joy powder that will surely win your heart.</p><br>
                            
                           
                            <form action="milkshChocoKisses.php" method="POST">
						...
						<script>
                            ...
                            <a class="nav-link" href="milkshChocoKisses.php" ><img src="https://img.icons8.com/material-rounded/22/000000/shopping-cart.png"/>ADD TO CART</a></button><br><br>
