...
<body class="bodycolor">
  ...
  <div class="container" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="img/Okinawa(bg).png" class="centerimage">
      </div>
      ...
      <div class="col-md-6">
        <div class="card" style="margin-top: 100px;">
          <div class="card-body">
            <div class="textcolor">
              <h4>Okinawa Milktea</h4><hr style="border-top: 1px solid;">
              <p>Indulge your tastebuds with yet another Japanese flavor: the Okinawa Milktea that has roasted brown sugar goodness.</p><br>
              
              <h3>Ingredients: </h3><br>
              <h5>Skimmed Milk, Black Tea Powder, Brown Sugar Flavor, Non-dairy creamer, Tapioca Pearls</h5><br><br>
