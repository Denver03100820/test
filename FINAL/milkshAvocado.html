        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card" style="margin-top: 100px;">
                    <div class="card-body">
                        <div class="textcolor">
                            <h4>Avocado Milkshake</h4><hr style="border-top: 1px solid;">
                            <p>Taste the creamy shake that is made of milk and avocado with love that will satisfy your avo-cravings.</p><br>
                           
                            <h3>Ingredients: </h3><br>
                            <h5>Whole Milk, Avocado, Granulated sugar, Vanilla extract, Vanilla Ice Cream</h5><br><br>
