...
<head>
    <meta charset="UTF-8">
    <title>Lhoyzki Milktea</title>
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
    <link rel="stylesheet" href="milktTaro.css" type="text/css">
...
<body class="bodycolor">
  ...
  <div class="container" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="img/RedVelvet(bg).png" class="centerimage">
      </div>
      ...
      <div class="col-md-6">
        <div class="card" style="margin-top: 100px;">
          <div class="card-body">
            <div class="textcolor">
              <h4>Red Velvet Milktea</h4><hr style="border-top: 1px solid;">
              <p>With mild fruity flavor blended with subtle taste of chocolate, this beverage will truly captivate you.</p><br>
              
              <h3>Ingredients: </h3><br>
              <h5>Milk, Water, Black Tea leaves, Sparlar panna cotta powder, Brown Sugar, Red Velvet Sauce, Tapioca Pearls</h5><br><br>
        ...
        <div class="row">
          ...
          <div class="col-md-3 ml-auto">
            ...
            <ul class="list-unstyled">
              ...
              <li>
                <span style="color: #f0ead6; font-family:'Comfortaa'; font-size: 14px;">Your opinions matter to us</span>
