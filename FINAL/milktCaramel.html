...
<body class="bodycolor">
  ...
  <div class="container" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="img/Caramel(bg).png" class="centerimage">
      </div>
      ...
      <div class="col-md-6">
        <div class="card" style="margin-top: 100px;">
          <div class="card-body">
            <div class="textcolor">
              <h4>Premium Caramel Sugar Milktea</h4><hr style="border-top: 1px solid;">
              <p>Enjoy the taste of our traditional Milktea blended with a touch of luscious Premium Caramel Sugar.</p><br>
              
              <h3>Ingredients: </h3><br>
              <h5>Milk, Water, Black Tea leaves, Caramel Syrup, Dark Brown Sugar, Tapioca Pearls</h5><br><br>
