...
<body class="fixed-bg">
  ...
  <div class="container" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="semi-card">
            <div class="textcolor">
              <h2 style="margin-left: 7px; margin-top:5px">Okinawa Milktea</h2><hr style="border-top: 1px solid;">
              <p style="font-size:15px; margin-left: 10px">Indulge your tastebuds with yet another Japanese flavor: the Okinawa Milktea that has roasted brown sugar goodness.</p><br>
              
               
                        <form action="milktOkinawa.php" method="POST">
						...
						<script>
                            ...
                            <a class="nav-link" href="milktOkinawa.php" ><img src="https://img.icons8.com/material-rounded/22/000000/shopping-cart.png"/>ADD TO CART</a></button><br><br>
