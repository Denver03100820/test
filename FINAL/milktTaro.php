...
<body class="bodycolor">
  ...
  <div class="container" style="margin-top:30px">
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <img src="img/Taro(bg).png" class="centerimage">
      </div>
      ...
      <div class="col-md-6">
        <div class="card" style="margin-top: 100px;">
          <div class="card-body">
            <div class="textcolor">
              <h4>Classic Taro Milktea</h4><hr style="border-top: 1px solid;">
              <p>Want some healthy Milktea? Then try this purple Taro goodness baby.</p><br>

              <h3>Ingredients: </h3><br>
              <h5>Whole Milk, Water, Loose Leaf Jasmine Green Tea, Taro Powder, Tapioca Pearls</h5><br><br>
