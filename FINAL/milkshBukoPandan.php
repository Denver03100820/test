        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card" style="margin-top: 100px;">
                    <div class="card-body">
                        <div class="textcolor">
                            <h4>Buko Pandan Milkshake</h4><hr style="border-top: 1px solid;">
                            <p>Be in love with this shake combined with coconut juice and screw pine leaves for a refreshing pandan moment.</p><br>
                            
                            <h3>Ingredients: </h3><br>
                            <h5>Evaporated Milk, Condensed Milk, Gelatin, Pandan Flavoring paste / liquid, Coconut Juice, White Sugar, Water, Tapioca Pearls</h5><br><br>
