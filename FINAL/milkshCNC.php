...
<body class="fixed-bg">
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            ...
            <div class="semi-card">
                        <div class="textcolor">
                            <h2 style="margin-left: 7px; margin-top:5px">Cookies 'n Cream Milkshake</h2><hr style="border-top: 1px solid;">
                            <p style="font-size:15px; margin-left: 10px">Get ready to taste our sweet and creamy shake with crushed oreos, that will surely get you crazy.</p><br>
                            
                            <form action="milkshCNC.php" method="POST">
						...
						<script>
                            ...
                            <a class="nav-link" href="milkshCNC.php" ><img src="https://img.icons8.com/material-rounded/22/000000/shopping-cart.png"/>ADD TO CART</a></button><br><br>
