    ...
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="card" style="margin-top: 100px;">
          <div class="card-body">
            <div class="textcolor">
              <h4>Hokkaido Milktea</h4><hr style="border-top: 1px solid;">
              <p>Feel the province of Japan with this one. Try out the Hokkaido Milktea and taste the blend of fresh tea leaves.</p><br>
              
              <h3>Ingredients: </h3><br>
              <h5>Milk, Water, Black tea leaves, Brown Sugar/Caramel Syrup, Tapioca Pearls</h5><br><br>
