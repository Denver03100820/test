        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card" style="margin-top: 100px;">
                    <div class="card-body">
                        <div class="textcolor">
                            <h4>Melon Milkshake</h4><hr style="border-top: 1px solid;">
                            <p>This shake will make you smile, it contains of lovely melon, attractive vanilla ice cream and a delicious milk.</p><br>
                            
                            <h3>Ingredients: </h3><br>
                            <h5>Whole Milk, Melon, Granulated sugar, Vanilla extract, Vanilla Ice Cream</h5><br><br>
