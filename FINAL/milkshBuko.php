...
<body class="fixed-bg">
    ...
    <div class="container" style="margin-top:30px">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <img src="img/Buko(bg).png" class="centerimage">
            </div>
            ...
            <div class="semi-card">
						...
						<script>
                            ...
                            <a class="nav-link" href="milkshBuko.php" ><img src="https://img.icons8.com/material-rounded/22/000000/shopping-cart.png"/>ADD TO CART</a></button><br><br>
